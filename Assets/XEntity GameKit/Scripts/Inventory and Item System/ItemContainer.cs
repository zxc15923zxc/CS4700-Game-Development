...
namespace XEntity.InventoryItemSystem
{
    ...
    public class ItemContainer : MonoBehaviour
    {
        ...
        protected void ToggleUI()
        {
            ...
            bool willClose = mainContainerUI.gameObject.activeSelf && isContainerUIOpen;
            bool willOpen = !mainContainerUI.gameObject.activeSelf && !isContainerUIOpen;
            ...
            else if (willOpen)
            {
                ...
                // Unlock and show cursor so player can click UI
